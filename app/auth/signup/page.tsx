...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        error instanceof Error ? error.message : 'אירעה שגיאה בהרשמה. אנא נסה שנית.'
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="container mx-auto py-8 px-4 relative z-10">
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8 relative">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="full-name" className="block text-sm font-medium text-gray-700 mb-1 text-right">
                  שם מלא
                </label>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">או הירשם באמצעות</span>
                </div>
              </div>
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      setError(error instanceof Error ? error.message : 'אירעה שגיאה בהרשמה עם גוגל');
                      setLoading(false);
                    }
                  }}
                  disabled={loading}
